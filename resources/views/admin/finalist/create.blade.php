...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Finalist Create Page</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card-body">
                        <div class="card-body table-responsive p-0">
                            <form method="post" action="/admin/finalist/store" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="subtitle" class="form-control" placeholder="Subtitle or Name .." value="{{ old('subtitle') }}">
                            ...
                            <div class="form-group">
                                <label>Line ID</label>
                                <input type="text" name="line_id" class="form-control" placeholder="Line ID .." value="{{ old('line_id') }}">
