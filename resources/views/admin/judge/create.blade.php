...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Judge Create Page</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card-body">
                        <div class="card-body table-responsive p-0">
                            <form method="post" action="/admin/judge/store" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                <label>Name</label>
                                <input type="text" name="name" class="form-control" placeholder="Name Judge .." value="{{ old('name') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="occupation" class="form-control" placeholder="Occupation Judge .." value="{{ old('occupation') }}">
