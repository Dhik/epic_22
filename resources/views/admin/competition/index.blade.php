...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Competition Page</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/admin/competition/edit/{{ $item->id }}" class="btn btn-success"><i class="nav-icon fas fa-pen"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
    ...
    <div class="modal fade" id="modal-default">
        <div class="modal-dialog">
          <div class="modal-content">
            <form action="/admin/message/delete" method="post">
                {{ csrf_field() }}
