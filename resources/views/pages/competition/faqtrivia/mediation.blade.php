...
<div class="container" data-aos="fade-up">
	<div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
		<div class="col-xl-7 col-lg-8">
			<h1 class="comp_title_li">Mediation Trivia 2022</h1>
		</div>
    </div>
</div>
</section>
...
<div class="container" data-aos="fade-up">
	<div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
		<div class="col-xl-7 col-lg-8">
			<h1 class="comp_title_li">Mediation FAQ 2022</h1>
		</div>
    </div>
</div>
</section>
...
<div class="container" data-aos="fade-up">
	<div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
		<div class="col-xl-10 col-lg-8">
            ...
            <p class="desc_ideation">&emsp;&emsp; <b>Q: Bagaimana jika ketika dalam pendaftaran tim tersebut tidak melanjutkan perlombaan hanya registrasi saja? </br></br></b>"Tim tersebut akan didiskualifikasi dan biaya pendaftaran tidak dapat kembali."</p>

            <p class="desc_ideation">&emsp;&emsp; <b>Q: Karya yang dilombakan apakah boleh karya yang sudah ada / pernah di publish sebelumnya?</br></br></b>"Karya yang dilombakan merupakan karya yang baru diproduksi dan belum pernah diikutsertakan pada perlombaan lainnya."</p>

            <p class="desc_ideation">&emsp;&emsp; <b>Q: Untuk sistem penilaian akan dinilai oleh siapa?</br></br></b>"Setiap karya akan dinilai oleh masing-masing juri sesuai dengan output karya."</p>
           
			<p class="desc_ideation">&emsp;&emsp; <b>Q: Bagaimana jika pengumpulan output tersebut telat?</br></br></b>"Pengumpulan karya diharapkan tepat waktu guna memperlancar proses penilaian dan lainnya. Panitia pun berhak mendiskualifikasi peserta yang tidak memenuhi syarat dan ketentuan yang berlaku."</p>
			</div>
		</div>
    </div>
</div>
