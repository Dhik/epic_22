...
<div class="container" data-aos="fade-up">
	<div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
		<div class="col-xl-7 col-lg-8">
			<h1 class="comp_title">Ideation Trivia 2022</h1>
		</div>
	</div>
</div>
</section>
...
<section class="d-flex align-items-center justify-content-center" id="overlay">
	<div class="container" data-aos="fade-up">
		<div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
			<div class="col-xl-10 col-lg-8">
				<p class="desc_comp">&emsp;&emsp; <b>Q: What series of activities will be held by IDEATION?</br></br></b>"There will be three series of activities held in Ideation 2022. The first activity that will be held on May 17th, 2022, is a workshop that aims to provide helpful knowledge for participants in preparing their work. Then a webinar aimed at the general public will be held on May 18th, 2022. Lastly, participants will present their work at the final presentation day on May 19th, 2022."</p>

				<p class="desc_comp">&emsp;&emsp; <b>Q: What theme is being brought up by the 2022 IDEATION?</br></br></b>"Ideation 2022 discusses the dangerous impacts of climate change that have occurred in various parts of the world, with the title of <b><i>“Communication to Action: Youth Changemakers for Climate Change.”</i></b>"</p>

				<p class="desc_comp">&emsp;&emsp; <b>Q: Who can participate in the IDEATION 2022 competition?</br></br></b>"Ideation 2022 is open for all active Associate’s (D3) and Undergraduate (D4/S1) Degree students that want to give their contribution in solving social issues, specifically climate change, through a communication perspective. Participants are groups consisting of three students that can be of different majors or faculties, but have to be from the same institution."</p>

				<p class="desc_comp">&emsp;&emsp; <b>Q: What is the output from IDEATION 2022?</br></br></b>"Ideators will compete to create the best creative proposal and pitch deck on the most effective communication strategies to educate people regarding the dangerous impacts of the world’s ongoing climate change."</p>

				<p class="desc_comp">&emsp;&emsp; <b>Q: How do you take part in the IDEATION 2022 competition?</br></br></b>"Ideators can register through the registration link that will be announced by the committee and follow further instructions."</p>

				<p class="desc_comp">&emsp;&emsp; <b>Q: How is the IDEATION 2022 series of activities timeline?</b>
				<table class="table">
					<tbody>
						<tr>
