...
<div class="container" data-aos="fade-up">
	<div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
		<div class="col-xl-10 col-lg-8">    
			<p class="desc_ideation">&emsp;&emsp; Did you know? The generation of FLW (Food Loss and Waste) in Indonesia in 2000–2019 reached an alarming figure, which was 23–48 million tons/year.</p>
			<p class="desc_ideation">&emsp;&emsp; Did you know? The largest generation of FLW (Food Loss and Waste) occurs at the consumption stage, which is 5–19 million tons/year. So, finish your food!</p>
			<p class="desc_ideation">&emsp;&emsp; Did you know? Food Loss and Waste does not only have an impact on the environment, but also has an impact on the potential for economic loss and the potential for loss of nutritional content.</p>
		</div>
    </div>
</div>
</section>
...
<div class="container" data-aos="fade-up">
	<div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
		<div class="col-xl-7 col-lg-8">
			<h1 class="comp_title_li">Liblicious FAQ 2022</h1>
		</div>
    </div>
</div>
</section>
